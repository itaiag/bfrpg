...
<h2>נשקים</h2>
    ...
    <div class="input-group  input-group-sm mb-3">
        <button id="addWeaponEqButton" class="btn btn-primary rounded">הוסף נשק</button>
    </div>
...
<h2>שריון</h2>
    ...
    <div class="input-group  input-group-sm mb-3">
        <button id="addArmorEqButton" class="btn btn-primary rounded">הוסף שריון</button>
    </div>
...
<h2>שונות</h2>
    ...
    <div class="input-group  input-group-sm mb-3">
        <button id="addItemEqButton" class="btn btn-primary rounded">הוסף פריט</button>
    </div>
...
<hr>
    ...
    <div class="grid g-0 justify-content-center " style="--bs-gap:0; --bs-columns:12">
        ...
        <div class="g-col-1">
            <label for="totalWeight" class="form-label">סה"כ</label>
...
function addWeaponEq() {
      ...
      var idNum = nextRowId('#weaponEqContainer');

    var inputGroup = inputContainer
      .append('div')
      .attr('class','grid align-content-center').attr('style','--bs-gap:0;--bs-columns:12;')
      .attr('id','weaponEq'+idNum)

    inputGroup
    .html(`
        <div class="g-col-1 mt-2">
            <input autocomplete="off" class="form-check-input weaponsEqMag" type="checkbox" value=""  id="itemMagical${idNum}">
        </div>
        <div class="g-col-1 mt-2">
            <input autocomplete="off" class="form-check-input weaponsEqEq" type="checkbox" value="" id="itemEquipped${idNum}">
        </div>
        <div class="g-col-8">
            <input autocomplete="off" type="text" class="form-control form-control-sm weaponsEqName"  id="itemName${idNum}">
        </div>
        <div class="g-col-1">
            <input autocomplete="off" type="text" class="form-control form-control-sm weight weaponsEqWeight"
            onkeypress="return event.charCode >= 46 && event.charCode <= 57" id="itemWeight${idNum}">
        </div>
    `)
    .on("input", calcWeight)
    .append('div')
...
function addArmorEq() {
      ...
      var idNum = nextRowId('#armorEqContainer');

    var inputGroup = inputContainer
      .append('div')
      .attr('class','grid align-content-center').attr('style','--bs-gap:0;--bs-columns:12;')
      .attr('id','armorEq'+idNum)

    inputGroup
    .html(`
        <div class="g-col-1 mt-2">
            <input autocomplete="off" class="form-check-input armorMagical" type="checkbox" value=""  id="armorMagical${idNum}">
        </div>
        <div class="g-col-1 mt-2">
            <input autocomplete="off" class="form-check-input armorEquipped" type="checkbox" value="" id="armorEquipped${idNum}">
        </div>
        <div class="g-col-8">
            <input autocomplete="off" type="text" class="form-control form-control-sm armorName"  id="armorName${idNum}">
        </div>
        <div class="g-col-1">
            <input autocomplete="off" type="text" class="form-control form-control-sm weight armorWeight"
            onkeypress="return event.charCode >= 46 && event.charCode <= 57" id="armorWeight${idNum}">
        </div>
    `)
    .on("input", calcWeight)
    .append('div')
...
function addItemEq() {
      ...
      var idNum = nextRowId('#miscEqContainer');

    var inputGroup = inputContainer
      .append('div')
      .attr('class','grid align-content-center').attr('style','--bs-gap:0;--bs-columns:12;')
      .attr('id','miscEq'+idNum)

    inputGroup
    .html(`
        <div class="g-col-1 mt-2">
            <input autocomplete="off" class="form-check-input miscMagical" type="checkbox" value=""  id="miscMagical${idNum}">
        </div>
        <div class="g-col-1 mt-2">
            <input autocomplete="off" class="form-check-input miscEquipped" type="checkbox" value="" id="miscEquipped${idNum}">
        </div>
        <div class="g-col-8">
            <input autocomplete="off" type="text" class="form-control form-control-sm miscName"  id="miscName${idNum}">
        </div>
        <div class="g-col-1">
            <input autocomplete="off" type="text" class="form-control form-control-sm weight miscWeight"
            onkeypress="return event.charCode >= 46 && event.charCode <= 57" id="miscWeight${idNum}">
        </div>
    `)
    .on("input", calcWeight)
    .append('div')
