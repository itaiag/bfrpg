...
<div id="hirelingsContainer" class="mb-3">
    <div class="input-group mb-2 rounded">
      <input autocomplete="off" type="text" class="form-control rounded hirelings" placeholder="שכיר 1" id="hireling1">
    </div>
</div>

<button id="addHirelingButton" class="btn btn-primary rounded">הוסף שכיר</button>
...
function addHireling() {
      ...
      var idNum = nextRowId('#hirelingsContainer');
